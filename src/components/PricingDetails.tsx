  ...
  const packages = [
    {
      ...
      image: 'https://images.unsplash.com/photo-1517604931442-7e0c8ed2963c' // Sample image
    },
    {
      name: 'Group Theater',
      price: '₹1599',
      ...
      image: 'https://images.unsplash.com/photo-1489599849927-2ee91cede3ba' // Sample image
    },
    {
      name: 'Couple Theater',
      price: '₹1111',
      ...
      image: 'https://images.unsplash.com/photo-1595769816263-9b910be24d5f' // Sample image
    }
  ];
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {fogEntries.map((fog) => (
              <div key={fog.name} className="bg-white p-6 rounded-lg shadow hover:shadow-lg transition duration-300">
                {/* <img src={fog.image} alt={fog.name} className="w-full h-32 object-cover mb-4" /> */}
